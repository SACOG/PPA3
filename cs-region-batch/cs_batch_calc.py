...
def complete_streets_idx(fc_pclpt, fc_project, project_type, posted_speedlim, transit_event_fc):
    ...
    if project_type == params.ptype_fwy or posted_speedlim <= 1: 
        ...
        lu_vals_obj = lubuff.LandUseBuffCalcs(fc_pclpt, fc_project, project_type, lu_fac_cols, params.cs_buffdist)
    ...
    with arcpy.da.InsertCursor(output_fc, [fld_geom, fld_strtname, fld_spd, fld_csi]) as inscur:
        with arcpy.da.SearchCursor(fl_network, fields_network) as cur:
            for i, row in enumerate(cur):
                ...
                csi_dict = complete_streets_idx(in_pcl_pt_fc, temp_fc_segment_path, project_type, speedlim, transit_event_fc)
...
if __name__ == '__main__':
    ...
    input_network_fc = 'Centerline_ArterialCollector10132021'
