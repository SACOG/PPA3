...
g_ESRI_variable_1 = 'C:\temp\TEMP_PPA_cs_data.gdb'
# Esri end of added variables

"""
Name: ppa_input_params.py
Purpose: Stores all input parameter values for SACOG Project Performance Assessment Tool
        Complete streets batch calculator
...
# ========================================INPUT DATA LAYERS===================================================== 
server_folder = "" # 10/14/2021 - not in use as of now

fgdb = "C:\PPA_CS_batch_temp\TEMP_PPA_cs_data.gdb"  # os.path.join(server_folder, gdb_name)
...
aggvals_csv = os.path.join(server_folder, r"PPA2\Input_Template\CSV\Agg_ppa_vals20220829_1258.csv")
