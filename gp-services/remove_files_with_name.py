...
def delete_files_of_type(folder, file_name, recursive_delete):
    path = Path(folder)
...
if __name__ == '__main__':
    ...
    file_type = input('Enter name of file you wish to delete (including extension). WARNING: This script will delete ALL files of with this name in ALL subfolders: ')
