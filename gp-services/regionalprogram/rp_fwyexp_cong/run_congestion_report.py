...
def make_congestion_rpt_fwyexp(fc_project, project_name, project_type, aadt):
...
if __name__ == '__main__':
    ...
    result_path = make_congestion_rpt_fwyexp(fc_project=project_fc, project_name=project_name,
                                            project_type=ptype, aadt=proj_aadt)
