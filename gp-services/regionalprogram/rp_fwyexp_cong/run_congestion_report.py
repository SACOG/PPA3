...
def make_congestion_rpt_fwyexp(input_dict):
    ...
    utils.log_row_to_table(data_row_dict=data_to_log, dest_table=os.path.join(params.log_fgdb, 'rp_fwy_cong'))
...
if __name__ == '__main__':
    ...
    # project_type = 'Freeway Expansion' # params.ptypes_fwy[0]
    ...
    result_path = make_congestion_rpt_fwyexp(input_dict=input_parameter_dict)
