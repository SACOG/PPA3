...
def update_json(json_loaded, data_year, order_val, fc_poly_parcels, project_fc, project_type,
    ...
    lu_rpt_obj = GetLandUseArea(project_fc, project_type, fc_poly_parcels)
    ...
    json_loaded[params.k_charts][k_chart_title][params.k_features][order_val][params.k_attrs]['year'] = data_year
