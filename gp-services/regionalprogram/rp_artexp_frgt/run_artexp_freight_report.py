...
def make_frgt_report_artexp(input_dict):
    ...
    for i, year in enumerate(data_years):
        ...
        d_pct_indjobs[year] = pct_ind_jobs

    pct_indjob_base = d_pct_indjobs[data_years[0]]
    pct_indjob_fut = d_pct_indjobs[data_years[1]]
    ...
    data_to_log = {
        ...
        'pct_empind_base': pct_indjob_base, 'pct_empind_fut': pct_indjob_fut
    }
...
if __name__ == '__main__':
    ...
    result_path = make_frgt_report_artexp(input_dict=input_parameter_dict)
